...
# Function to display images with messages
def display_image_with_message(image_path, message):
    print(message)  # Print message before displaying image
...
# Display Learning Rate Monitoring
print("\nMethod for monitoring LR:")
display_image_with_message("step6_LR_loss.png", "LR model converged at 20 iterations.")

# Display Neural Network Monitoring
print("\nMethod for monitoring NN:")
display_image_with_message("step6_NN_loss.png", "NN model converged at 2500 epochs.")

# Display Physics-Informed Neural Network Monitoring
print("\nMethod for monitoring PINN:")
display_image_with_message("step6_PINN_loss.png", "PINN model converged at 3000 iterations.")

# Final message to locate models
print("\nPlease find the final models at their respective converged iterations and epochs.")
...
for i in range(num_iterations):
    ...
    # Store test predictions every 100 iterations
    if i % 100 == 0: 
        with torch.no_grad():
...
plot_results(t_test, u_test, u_pred_lr, "Polynomial Regression at 20 Iterations", lr_time, "step4_LR.png")
plot_results(t_test, u_test, u_pred_nn, "Neural Network at 2500 Epochs", nn_time, "step4_NN.png")
plot_results(t_test, u_test, u_pred_pinn, "PINN at 3000 Iterations", pinn_time, "step4_PINN.png")
